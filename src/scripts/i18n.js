    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'smartAnswer.practical-examples': 'Practical Examples',
                'smartAnswer.frequently-asked': 'Frequently Asked Questions',
                'smartAnswer.key-takeaways': 'Key Takeaways',
                'smartAnswer.related-topics': 'Related Topics',
                'smartAnswer.legal-sources': 'Legal Sources',
                'smartAnswer.confidence': 'Confidence',
                'smartAnswer.helpful': 'Helpful',
                'smartAnswer.share': 'Share',
                'smartAnswer.view-legal': 'View Legal',
                'smartAnswer.ask-more': 'Ask More',
                'smartAnswer.example': 'Example',
                'smartAnswer.question': 'Question',
                'smartAnswer.answer': 'Answer',
                'smartAnswer.calculation': 'Calculation',
                'smartAnswer.important-note': 'Important Note',
                'smartAnswer.show-details': 'Show Details',
                'smartAnswer.hide-details': 'Hide Details',
                'smartAnswer.expand-section': 'Expand section',
                'smartAnswer.collapse-section': 'Collapse section',
                'smartAnswer.smart-answer-generated': 'Smart answer generated based on legal analysis',
                'smartAnswer.confidence-high': 'High confidence answer',
                'smartAnswer.confidence-medium': 'Medium confidence answer', 
                'smartAnswer.confidence-low': 'Low confidence answer',
                'smartAnswer.based-on-articles': 'Based on {{count}} legal articles',
                'smartAnswer.view-sources': 'View Sources',
                'smartAnswer.was-helpful': 'Was this helpful?',
                'smartAnswer.yes-helpful': 'Yes',
                'smartAnswer.no-helpful': 'No',
                'smartAnswer.improve-answer': 'Help us improve this answer',
                'smartAnswer.related-legal-articles': 'Related Legal Articles'
            },
            ...
            es: {
                ...
                // Smart Answer System
                'smartAnswer.quick-answer': 'Respuesta Rápida',
                'smartAnswer.detailed-explanation': 'Explicación Detallada',
                'smartAnswer.practical-examples': 'Ejemplos Prácticos', 
                'smartAnswer.frequently-asked': 'Preguntas Frecuentes',
                'smartAnswer.key-takeaways': 'Puntos Clave',
                'smartAnswer.related-topics': 'Temas Relacionados',
                'smartAnswer.legal-sources': 'Fuentes Legales',
                'smartAnswer.confidence': 'Confianza',
                'smartAnswer.helpful': 'Útil',
                'smartAnswer.share': 'Compartir',
                'smartAnswer.view-legal': 'Ver Legal',
                'smartAnswer.ask-more': 'Preguntar Más',
                'smartAnswer.example': 'Ejemplo',
                'smartAnswer.question': 'Pregunta',
                'smartAnswer.answer': 'Respuesta',
                'smartAnswer.calculation': 'Cálculo',
                'smartAnswer.important-note': 'Nota Importante',
                'smartAnswer.show-details': 'Mostrar Detalles',
                'smartAnswer.hide-details': 'Ocultar Detalles',
                'smartAnswer.expand-section': 'Expandir sección',
                'smartAnswer.collapse-section': 'Contraer sección',
                'smartAnswer.smart-answer-generated': 'Respuesta inteligente generada basada en análisis legal',
                'smartAnswer.confidence-high': 'Respuesta de alta confianza',
                'smartAnswer.confidence-medium': 'Respuesta de confianza media',
                'smartAnswer.confidence-low': 'Respuesta de baja confianza',
                'smartAnswer.based-on-articles': 'Basado en {{count}} artículos legales',
                'smartAnswer.view-sources': 'Ver Fuentes',
                'smartAnswer.was-helpful': '¿Te fue útil?',
                'smartAnswer.yes-helpful': 'Sí',
                'smartAnswer.no-helpful': 'No',
                'smartAnswer.improve-answer': 'Ayúdanos a mejorar esta respuesta',
                'smartAnswer.related-legal-articles': 'Artículos Legales Relacionados'
            },
            ...
            hr: {
                ...
                // Smart Answer System
                'smartAnswer.quick-answer': 'Brzi Odgovor',
                'smartAnswer.detailed-explanation': 'Detaljno Objašnjenje',
                'smartAnswer.practical-examples': 'Praktični Primjeri',
                'smartAnswer.frequently-asked': 'Često Postavljana Pitanja',
                'smartAnswer.key-takeaways': 'Ključne Točke', 
                'smartAnswer.related-topics': 'Povezane Teme',
                'smartAnswer.legal-sources': 'Pravni Izvori',
                'smartAnswer.confidence': 'Pouzdanost',
                'smartAnswer.helpful': 'Korisno',
                'smartAnswer.share': 'Podijeli',
                'smartAnswer.view-legal': 'Pogledaj Pravno',
                'smartAnswer.ask-more': 'Pitaj Više',
                'smartAnswer.example': 'Primjer',
                'smartAnswer.question': 'Pitanje',
                'smartAnswer.answer': 'Odgovor',
                'smartAnswer.calculation': 'Izračun',
                'smartAnswer.important-note': 'Važna Napomena',
                'smartAnswer.show-details': 'Prikaži Detalje',
                'smartAnswer.hide-details': 'Sakrij Detalje',
                'smartAnswer.expand-section': 'Proširi odjeljak',
                'smartAnswer.collapse-section': 'Smanji odjeljak',
                'smartAnswer.smart-answer-generated': 'Pametni odgovor generiran na osnovu pravne analize',
                'smartAnswer.confidence-high': 'Odgovor visoke pouzdanosti',
                'smartAnswer.confidence-medium': 'Odgovor srednje pouzdanosti',
                'smartAnswer.confidence-low': 'Odgovor niske pouzdanosti',
                'smartAnswer.based-on-articles': 'Temelji se na {{count}} pravnih članaka',
                'smartAnswer.view-sources': 'Pogledaj Izvore',
                'smartAnswer.was-helpful': 'Je li vam ovo pomoglo?',
                'smartAnswer.yes-helpful': 'Da',
                'smartAnswer.no-helpful': 'Ne',
                'smartAnswer.improve-answer': 'Pomozite nam poboljšati ovaj odgovor',
                'smartAnswer.related-legal-articles': 'Povezani Pravni Članci'
            }
        };
